...
const ProjectItem = ({
    ...
    return (
        <Link
            ...
            className="text-sm text-white font-medium py-1 flex items-center justify-between w-full group transition-colors"
        >
            <div className="flex items-center gap-2">
                {getProjectIcon(data)}
            ...
            {rest.length > 0 && (
                <div className="flex flex-col gap-2">
                    <div className="flex items-center justify-between gap-2">
                        ...
                        <button
                            onClick={onViewAll}
                            className="flex items-center gap-2 text-muted-foreground text-xs hover:text-white transition-colors"
                        >
                            <span>View all</span>
